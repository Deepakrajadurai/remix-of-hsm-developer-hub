...
const BlogEdit = () => {
    ...
    useEffect(() => {
        const fetchBlog = async () => {
            ...
            try {
                ...
                setPublished(!!data.published); // Ensure boolean
            } catch (err) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                title: 'Error',
                description: err.message || 'Failed to update article. Please try again.',
                variant: 'destructive',
            });
        } finally {
            setSaving(false);
        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="pt-24 pb-20">
                <div className="container mx-auto px-4 max-w-4xl">
                    <Link to={`/blog/${id}`} className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-8">
