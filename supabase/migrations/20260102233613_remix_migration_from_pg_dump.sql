...
CREATE TABLE public.resources (
    ...
    description text,
    url text,
    category text DEFAULT 'documentation'::text NOT NULL,
    icon text,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: events Only admins can create events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Only admins can create events" ON public.events FOR INSERT TO authenticated WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));


--
-- Name: resources Only admins can create resources; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Only admins can create resources" ON public.resources FOR INSERT TO authenticated WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "Only admins can delete events" ON public.events FOR DELETE TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));


--
-- Name: resources Only admins can delete resources; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Only admins can delete resources" ON public.resources FOR DELETE TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "Only admins can update events" ON public.events FOR UPDATE TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));


--
-- Name: resources Only admins can update resources; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Only admins can update resources" ON public.resources FOR UPDATE TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
--
-- Name: resources Resources are viewable by everyone; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: posts Users can view their own unpublished posts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own unpublished posts" ON public.posts FOR SELECT USING ((auth.uid() = user_id));
